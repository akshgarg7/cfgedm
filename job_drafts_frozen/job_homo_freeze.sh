#!/bin/bash
#SBATCH --job-name=job_fz_homo
#SBATCH --output=./logs/job_fz_homo_%j.out
#SBATCH --error=./logs/job_fz_homo_%j.err
...
python main_qm9.py --exp_name light_adapter_single_cfg_frozen_homo \
                   --model egnn_dynamics \
                   --lr 2e-4 \
                   --nf 192 \
                   --n_layers 9 \
