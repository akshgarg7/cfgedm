#!/bin/bash
#SBATCH --job-name=job_PROPERTY_PLACEHOLDER
#SBATCH --output=./logs/job_PROPERTY_PLACEHOLDER_%j.out
#SBATCH --error=./logs/job_PROPERTY_PLACEHOLDER_%j.err
...
python main_qm9.py --exp_name icml_sin_PROPERTY_PLACEHOLDER \
