#!/bin/bash
#SBATCH --job-name=eval_PROPERTY_resume_qual_guid_GUIDANCE_WEIGHT_
#SBATCH --output=./logs/eval_PROPERTY_resume_qual_guid_GUIDANCE_WEIGHT_%j.out
#SBATCH --error=./logs/eval_PROPERTY_resume_qual_guid_GUIDANCE_WEIGHT_%j.err
