...
for property in "${properties[@]}"; do
    ...
    job_name="job_${property1}_${property2}"
    sed "s/JOB_NAME_PLACEHOLDER/${property1}_${property2}/g; \
         ...
         s/PROPERTY2_PLACEHOLDER/${property2}/g" experiments/two_template_resume.sh > temp_job_${property1}_${property2}_resume.sh

    sbatch temp_job_${property1}_${property2}_resume.sh
